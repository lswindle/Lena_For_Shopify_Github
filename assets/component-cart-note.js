...
class CartNote extends HTMLElement {
  constructor() {
    super();
    this.handleCartNotes = this.handleCartNotes.bind(this);
  }
  ...
  init() {
    this.handleCartNotes();
    this.attachEvents();
    window.eight.armada.elementRegistry.register({key: 'component-cart-note', assetPath: '/assets/component-cart-note.min.js'});
  }

  attachEvents() {
    if (window.Shopify.designMode) {
      window.addEventListener('resize', this.handleCartNotes);
    }
  }
  ...
  detachEvents() {
    if (window.Shopify.designMode) {
      window.removeEventListener('resize', this.handleCartNotes);
    }
  }
