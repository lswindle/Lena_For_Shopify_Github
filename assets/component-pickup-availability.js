...
class PickupAvailability extends HTMLElement {
  ...
  init() {
    ...
    window.eight.armada.elementRegistry.register({key: 'pickup-availability', assetPath: '/assets/component-pickup-availability.min.js'});
  }

  fetchAvailability(variantId) {
    const variantSectionUrl = `${this.dataset.baseUrl}variants/${variantId}/?section_id=section-pickup-availability`;
    ...
    fetch(variantSectionUrl)
      ...
      .catch(e => {
        this.querySelector('[data-armada-selector="pickup-refresh"]')?.removeEventListener('click', this.onClickRefreshList);
        this.renderError();
      });
  }
  ...
  renderError() {
    ...
    this.querySelector('[data-armada-selector="pickup-refresh"]').addEventListener('click', this.onClickRefreshList);
  }
