...
class SearchToggle extends HTMLElement {
  constructor() {
    super();
    this.searchToggle = this.querySelector('[data-armada-selector="search_toggle"]');
  }
  ...
  init() {
    ...
    window.eight.armada.elementRegistry.register({key: 'search-toggle', assetPath: '/assets/component-search-toggle.min.js'});
  }

  openSearch(e) {
    e.preventDefault();
    window.eight.eventsEngine.emit(`${eight.constants.events["ARMADA:SEARCH:TOGGLE"]}`);
  }
}
